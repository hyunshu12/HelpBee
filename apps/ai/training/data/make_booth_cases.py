...
BOOTH_CASES: list[BoothCaseSpec] = [
    # 2026-09-16 전면 교체: "눈으로 구분하기 힘든 것만". 세 라운드가 독립 동전던지기
    # (병 | 정상)라 두 무리가 **겉보기에 같아야** 한다 — 전부 벌·애벌레로 빽빽한
    # 소비판 광각이고, 병든 개체는 수십 마리 중 한둘이다.
    #
    # 선정 기준: 라벨 박스 중앙값 면적 < 5% (광각) · 병든 개체 비율 ≤ 15% ·
    # 정상은 응애 0·다른 병 0 · compute_risk 가 safe 를 주는 응애 사진은 제외
    # (1/83 같은 건 감염률 1.2% 라 화면에 '안전' 배지가 떠서 정답과 모순된다).
    # ── 응애 (5) — 응애 1마리 **+ 다른 병 1~4** / 전체 8~33 (2026-09-16 재선정)
    # 2·3라운드용. 응애만 있는 사진이 아니라 부저병·날개불구·석고병이 같이 있는
    # 사진으로 골랐다 — 결과 화면에서 "응애 말고도 이런 게 있었다"가 같이 보이고,
    # 관람객이 다른 병을 보고 '문제 있음'을 맞혀도 응애는 못 봤다는 대비가 선다.
    BoothCaseSpec("varroa-1", "성충/성충_응애/068/B_001_007_20230827133939_001_001_001_001",
                  1.55, 1.25, "varroa", "varroa", "응애"),  # +날개불구 2 +부저병 1 / 33
    BoothCaseSpec("varroa-2", "유충/유충_석고병/049/B_001_001_20230819135434_001_001_000_002",
                  1.35, 1.20, "varroa", "varroa", "응애"),  # +부저병 4 / 16
    BoothCaseSpec("varroa-3", "성충/성충_응애/069/B_001_007_20230828135315_001_004_001_001",
                  1.30, 1.15, "varroa", "varroa", "응애"),  # +부저병 2 / 10
    BoothCaseSpec("varroa-4", "성충/성충_응애/012/B_001_001_20230823133123_001_003_001_001",
                  1.30, 1.15, "varroa", "varroa", "응애"),  # +날개불구 1 / 8
    BoothCaseSpec("varroa-5", "성충/성충_응애/056/B_001_006_20230820112135_001_004_001_001",
                  1.30, 1.15, "varroa", "varroa", "응애"),  # +부저병 1 / 9
    # ── 다른 병 (4) — 1라운드용. 병든 개체 1~3 / 전체 15~52. 화면 병명은 build_case 가 라벨에서 정한다.
    # 1라운드 선택지(정상·날개불구·부저병)에 없는 석고병은 넣지 않는다.
    BoothCaseSpec("dwv-1", "성충/성충_날개불구바이러스감염증/002/B_001_001_20230821082418_001_003_001_002",
                  1.30, 1.15, "visible", "dwv", "날개불구 바이러스"),
    BoothCaseSpec("dwv-2", "성충/성충_날개불구바이러스감염증/011/B_001_001_20230824080642_001_003_001_002",
                  1.30, 1.15, "visible", "dwv", "날개불구 바이러스"),
    BoothCaseSpec("foul-1", "유충/유충_석고병/024/B_001_001_20230819135317_001_002_000_002",
                  1.35, 1.20, "visible", "foulbrood", "부저병"),
    BoothCaseSpec("foul-2", "유충/유충_석고병/050/B_001_001_20230819135434_001_002_000_002",
                  1.35, 1.20, "visible", "foulbrood", "부저병"),
    # ── 정상 (5) — 응애 0 · 다른 병 0 인 것만
    BoothCaseSpec("healthy-1", "성충/성충_정상/005/B_001_001_20230819135627_001_003_001_000",
                  1.50, 1.25, "healthy", None, None),
    BoothCaseSpec("healthy-2", "성충/성충_정상/057/B_001_001_20230822083827_001_004_001_000",
                  1.50, 1.25, "healthy", None, None),
    BoothCaseSpec("healthy-3", "성충/성충_정상/051/B_001_001_20230821083745_001_001_001_000",
                  1.30, 1.15, "healthy", None, None),
    BoothCaseSpec("healthy-4", "성충/성충_정상/083/B_001_001_20230822084218_001_003_001_000",
                  1.30, 1.15, "healthy", None, None),
    BoothCaseSpec("healthy-5", "성충/성충_정상/029/B_001_001_20230821082418_001_001_001_000",
                  1.30, 1.15, "healthy", None, None),
]
