...
BOOTH_CASES: list[BoothCaseSpec] = [
    ...
    # ── 응애 (5) — 감염 1마리 / 전체 5~33
    BoothCaseSpec("varroa-1", "성충/성충_응애/024/B_001_003_20230820110731_001_002_001_001",
                  1.25, 1.15, "varroa", "varroa", "응애"),
    BoothCaseSpec("varroa-2", "성충/성충_응애/074/B_001_008_20230825084547_001_004_001_001",
                  1.55, 1.25, "varroa", "varroa", "응애"),
    BoothCaseSpec("varroa-3", "성충/성충_응애/068/B_001_007_20230827133939_001_001_001_001",
                  1.55, 1.25, "varroa", "varroa", "응애"),
    BoothCaseSpec("varroa-4", "성충/성충_응애/025/B_001_003_20230821085014_001_002_001_001",
                  1.30, 1.15, "varroa", "varroa", "응애"),
    BoothCaseSpec("varroa-5", "성충/성충_응애/070/B_001_007_20230829091748_001_001_001_001",
                  1.30, 1.15, "varroa", "varroa", "응애"),
    # ── 다른 병 (5) — 병든 개체 1~3 / 전체 15~52. 화면 병명은 build_case 가 라벨에서 정한다.
    ...
    BoothCaseSpec("foul-2", "유충/유충_석고병/050/B_001_001_20230819135434_001_002_000_002",
                  1.35, 1.20, "visible", "foulbrood", "부저병"),
    # "정상" 폴더에 있지만 라벨엔 석고병 2개 — 폴더명 ≠ 라벨의 좋은 예.
    BoothCaseSpec("chalk-1", "성충/성충_정상/066/B_001_001_20230822083837_001_003_001_000",
                  1.30, 1.15, "visible", "chalkbrood", "석고병"),
